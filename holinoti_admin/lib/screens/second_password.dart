          ...
          actions: <Widget>[
            StreamBuilder<Enums.SecondPassMode>(
                ...
                builder: (context, snapshot) {
                  ...
                  return snapshot.data == Enums.SecondPassMode.verify
                      ? MaterialButton(
                          child: Text(
                            Strings.SecondPasswordPage.INIT_PASSWORD,
                            style: TextStyle(
                              color: Colors.white,
                            ),
                          ),
                          onPressed: () =>
                              _secondPasswordBloc.initPassword(context),
                        )
                      : Container();
                }),
          ],
                  ...
                  StreamBuilder<Enums.SecondPassMode>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.data == Enums.SecondPassMode.verify) {
                          text =
                              Strings.SecondPasswordPage.PLEAS_INPUT_PASSWORD;
                        } else if (snapshot.data == Enums.SecondPassMode.init) {
                          text = Strings.SecondPasswordPage.INPUT_NEW_PASSWORD;
                        } else {
                          text = Strings
                              .SecondPasswordPage.ONE_MORE_INPUT_PASSWORD;
                        }
                        return Text(
                          text,
                  ...
                  children: List.generate(12, (index) {
                    ...
                    switch (index) {
                      ...
                      default:
                        ...
                        onPressed = () => _secondPasswordBloc.addPassNum(
                            context, (index + 1));
                        break;
                    }
