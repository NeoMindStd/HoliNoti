...
class HomeBloc {
  ...
  void moveToAuthPage(BuildContext context, AuthBloc authBloc) => Navigator.push(
    context,
    platformPageRoute(
      context: context,
  ...
  void moveToRegisterFacilityPage(BuildContext context,
      RegisterFacilityBloc registerFacilityBloc) => Navigator.push(
    context,
    platformPageRoute(
      context: context,
  ...
  void moveToRegisterOpeningInfoPage(BuildContext context,
      RegisterOpeningInfoBloc registerOpeningInfoBloc) => Navigator.push(
    context,
    platformPageRoute(
      context: context,
      builder: (context) => RegisterOpeningInfoPage(registerOpeningInfoBloc),
    ),
  );
